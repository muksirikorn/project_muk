...
class Constant {
  ...
  static const String PROVINCE_ROUTE = "/province";
  static const String DISTRICT_ROUTE = "/district";
  static const String NAME_SHOP_ROUTE = "/nameshop";
  static const String LOCATION_DETAIL_ROUTE = "/location_detail";
  static const String LOGIN_ROUTE = "/login";
  static const String REIGTER_ROUTE = "/register";
